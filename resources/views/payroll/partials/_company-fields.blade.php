...
<div class="form-wizard" data-wizard>
    ...
    <div class="form-step" data-step="Company">
        <div class="row g-3">
            ...
            <div class="col-md-6">
                <label class="form-label">Company Logo <span class="opt">optional</span></label>
    ...
    <div class="form-step" data-step="Legal">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                <label class="form-label">TAN Number <span class="opt">optional</span></label>
                <input name="tan_number" class="form-control text-uppercase" value="{{ old('tan_number', $c->tan_number ?? '') }}">
            </div>
            <div class="col-md-6">
                <label class="form-label">PF Registration Number <span class="opt">optional</span></label>
                <input name="pf_registration_number" class="form-control" value="{{ old('pf_registration_number', $c->pf_registration_number ?? '') }}">
            </div>
            <div class="col-md-6">
                <label class="form-label">ESIC Registration Number <span class="opt">optional</span></label>
                <input name="esic_registration_number" class="form-control" value="{{ old('esic_registration_number', $c->esic_registration_number ?? '') }}">
            </div>
            <div class="col-12">
                <label class="form-label">Professional Tax Registration Number <span class="opt">optional</span></label>
    ...
    <div class="form-step" data-step="Signatory">
        ...
        <div class="row g-3">
            <div class="col-md-6">
                <label class="form-label">Authorized Person Name<span class="req">*</span></label>
            ...
            <div class="col-md-4">
                <label class="form-label">Signature Image <span class="opt">optional</span></label>
    ...
    <div class="form-step" data-step="Banking">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                <label class="form-label">Branch Name <span class="opt">optional</span></label>
